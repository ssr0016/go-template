...
import (
	...
	"github.com/ssr0016/booking/internal/handlers"
...
func main() {
	...
	// msg := models.MailData{
	// 	To:      "K4Vw0@example.com",
	// 	From:    "K4Vw0@example.com",
	// 	Subject: "Test Email",
	// 	Content: "Hello, world!",
	// }
...
func run() (*driver.DB, error) {
	...
	db, err := driver.ConnectSQL("host=localhost port=5433 user=postgres password=postgres dbname=bookings sslmode=disable")
	if err != nil {
